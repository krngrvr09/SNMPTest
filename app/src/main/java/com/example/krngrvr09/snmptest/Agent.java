...
/**
 * Created by krngrvr09 on 28/4/15.
 */
...
public class Agent extends BaseAgent {
    ...
    public Agent(String address) throws IOException {
        ...
        super(new File(Environment.getExternalStorageDirectory(),"conf.agent"), new File(Environment.getExternalStorageDirectory(),"bootCounter.agent"),
